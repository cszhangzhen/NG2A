...
def main():
    ...
    parser.add_argument('--epochs', type=int, default=300, help='number of epochs to train (default: 100)')
    ...
    parser.add_argument('--input_model_file', type=str, default = './init_weights/model_100.pth', help='filename to read the model (if there is any)')
